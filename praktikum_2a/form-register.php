...
<head>
    ...
    <title>Form Register Club Data Science</title>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124186" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Deananda Meuthia" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenis_kelamin" id="jenis_kelamin_laki" type="radio" class="custom-control-input" value="laki-laki" required="required" checked> 
        <label for="jenis_kelamin_laki" class="custom-control-label">Laki-laki</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenis_kelamin" id="jenis_kelamin_perempuan" type="radio" class="custom-control-input" value="perempuan" required="required"> 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      foreach($ar_skill as $nama => $nilai){
        ...
        echo "<input name='skill[]' id='skill_$nama' 
